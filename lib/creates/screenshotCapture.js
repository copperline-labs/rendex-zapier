...
exports.default = {
    ...
    display: {
        ...
        description: "Capture a screenshot of a webpage or HTML snippet. Returns a PNG, JPEG, or WebP image file synchronously. For heavy pages (full-page scrolls of news sites, e-commerce, or dashboards), use Capture Screenshot (Async) instead — Zapier's 30-second action timeout often trips on large sync captures.",
    },
    operation: {
        inputFields: [

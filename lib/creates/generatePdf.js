...
exports.default = {
    ...
    display: {
        label: "Generate PDF",
        description: "Generate a PDF document from a webpage or HTML snippet synchronously. Supports custom page sizes, margins, and landscape orientation. For long-form or heavy pages, prefer Capture Screenshot (Async) with Format = PDF — Zapier's 30-second action timeout often trips on large sync PDF renders.",
    },
    operation: {
        inputFields: [

...
const aiSummaryField = {
    ...
    type: "boolean",
    required: false,
    helpText: "Optional. Add an AI-written one-line summary of what changed to each alert (requires a Rendex Pro or Enterprise plan — not related to your Zapier plan). Every plan already gets a plain templated summary; this upgrades it to a natural-language sentence for text changes.",
};

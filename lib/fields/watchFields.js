...
exports.UPDATE_WATCH_FIELDS = exports.TEST_WATCH_FIELDS = exports.CREATE_WATCH_FIELDS = void 0;
const urlField = {
    key: "url",
    label: "Web Page URL",
    type: "string",
...
const intervalField = {
    ...
    default: "1440",
    required: false,
    helpText: "How frequently to look for changes. Faster checking needs a higher plan — if you pick a speed your plan doesn't allow, you'll get a message with the fastest option available to you.",
};
const diffModeField = {
    key: "diffMode",
    ...
    type: "string",
    choices: {
        visual: "Visual — how the page looks",
        text: "Text — the words on the page",
        both: "Both",
    },
    default: "visual",
    required: false,
    helpText: "Watch for changes in how the page looks (layouts, prices, banners), the words on it, or both.",
};
const thresholdField = {
    ...
    type: "string",
    choices: {
        "0.05": "Only noticeable changes",
        "0.01": "Normal (recommended)",
        "0.001": "Even tiny changes",
    },
    default: "0.01",
    required: false,
    helpText: "How much of the page has to change before you're alerted. Applies to visual checks.",
};
const notifyEmailField = {
    ...
    type: "string",
    required: false,
    helpText: "Send change alerts to this email. Must be your own account email. Leave blank to use the email on your account — or skip email entirely and use the \"Website Changed\" trigger to run a Zap. On the Update action, type \"-\" or \"none\" here to stop emailing this watch.",
};
const selectorField = {
    key: "selector",
    ...
    type: "string",
    required: false,
    helpText: "Optional. A CSS selector (e.g. \"#price\") to watch just one element — a price, a banner, a heading — instead of the whole page.",
};
...
const ignoreTextField = {
    ...
    type: "text",
    required: false,
    helpText: "Optional. Lines of text to ignore so they don't trigger a false alert — e.g. a clock, a visitor counter, or \"Updated 5 minutes ago\". One per line. Applies to text checks.",
};
...
const suppressWhilePresentField = {
    ...
    type: "text",
    required: false,
    helpText: "Optional. While the page contains any of these words (one per line) — like \"Out of stock\" or \"Loading\" — changes are ignored until they clear.",
};
const formatField = {
    key: "format",
    label: "Capture As",
...
const geoField = {
    ...
    type: "string",
    required: false,
    helpText: "Optional. A 2-letter country code (e.g. US, DE, JP) to check the page as seen from that country. Geo-targeting is visual-only — it can't be combined with a text or both diff mode. Pro plan and above.",
};
const uaModeField = {
    key: "uaMode",
...
const webhookUrlField = {
    ...
    type: "string",
    required: false,
    helpText: "Optional and advanced. Most people can leave this blank and use the \"Website Changed\" trigger instead. Requires a Starter plan or higher. On the Update action, type \"-\" or \"none\" here to remove an existing webhook.",
};
...
exports.CREATE_WATCH_FIELDS = [urlField, ...SHARED_OPTIONAL_FIELDS, pausedCreateField];
...
exports.TEST_WATCH_FIELDS = [urlField, diffModeField, ...TEST_RENDER_FIELDS];
...
exports.UPDATE_WATCH_FIELDS = [updateUrlField, ...SHARED_OPTIONAL_FIELDS, pauseResumeField];
//# sourceMappingURL=watchFields.js.map